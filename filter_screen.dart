            ...
            children: [
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 10),
                      Text(selectedMonth ?? "Select move in month",
              ...
              Wrap(
                ...
                children: propertyTypes.map((type) {
                  return buildSelectableButton(type, "property", selectedPropertyType == type);
                }).toList(),
              ),
              SizedBox(height: 20),
              ...
              Wrap(
                ...
                children: roomTypes.map((type) {
                  return buildSelectableButton(type, "room", selectedRoomType == type);
                }).toList(),
              ),
              SizedBox(height: 20),
              ...
              Wrap(
                spacing: 10,
                children: sharingOptions.map((option) {
                  return buildSelectableButton(option, "sharing", selectedSharing.contains(option));
                }).toList(),
              ),
              SizedBox(height: 20),
