...
import 'package:chennai_nest/main_screen2.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    context,
    MaterialPageRoute(builder: (context) => ChatScreen4()),
  );
          },
        ),
      ...
      body: Column(
        children: [
          ...
          GestureDetector( // Wrap the Card with GestureDetector
            onTap: () {
              // Navigate to the home page when the card is tapped
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) => HotelListingScreen()), // Replace MyHomePage with your actual home page widget
              );
            },
